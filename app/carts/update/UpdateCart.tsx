...
const postBody = {
  ...
  body: {
    ...
    actions: [
      {
        action: 'addLineItem',
        productId: 'b065613a-c6b0-42cf-ad95-dd51684a9232',
        quantity: 2,
      },
      {
        action: 'addLineItem',
        productId: '93a8346e-feb1-47af-a4ab-fd582eb8942d',
        quantity: 3,
      },
    ],
  },
...
const UpdateCart = async () => {
  const cartId = '805cdc6e-a15e-477e-aaee-9383ad93070d';
  const response = await cartUpdate('id', cartId, postBody);
  const responseBody = response?.body;

  return (
    <div className="grid grid-cols-2 gap-5 m-10 justify-center align-middle text-center">
      {/************* Lastest Updated Cart ***************/}
