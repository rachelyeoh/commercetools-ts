...
import { productImportCreate } from './productImportCreate';
...
const resources = [
  {
    key: 'limited-edition-t-shirt',
    name: { en: 'Limited Edition Branded T-shirt' },
    productType: {
      typeId: 'product-type',
      key: 'product-sets',
    },
    slug: { en: 'limited-edition-t-shirt' },
    description: { en: 'Limited Edition Branded T-shirt for women and men' },
    categories: categories,
    metaTitle: {
      en: 'Limited Edition Branded T-shirt',
    },
    metaDescription: {
      en: 'Limited Edition Branded T-shirt for women and men',
    },
    metaKeywords: {
      en: 'Limited Edition Branded T-shirt for women and men',
    },
...
const productImportRequest = {
  type: 'product',
  resources: resources,
};

const importContainerKey = '2nd-container';

const CreateProductImport = async () => {
  const response = await productImportCreate(
    importContainerKey,
...
export default CreateProductImport;
