...
import { standalonePriceImportCreate } from './standalonePriceImportCreate';

const resources = [
  {
    key: 'fixed-20-no-discount',
    sku: 'GMCT-01',
    value: {
      centAmount: '2000',
      currencyCode: 'USD',
...
const standalonePriceImportRequest = {
...
const CreateStandalonePriceImport = async () => {
  const response = await standalonePriceImportCreate(
    importContainerKey,
...
export default CreateStandalonePriceImport;
